...
| Error monitoring | Unhandled exceptions, breadcrumbs | Production error tracking | Sentry project members (owner) | Per Sentry project retention | Per Sentry account settings | **Sentry** — `beforeSend` scrubbing not yet configured (`SEC-013` follow-up) |
