      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="min-w-0">
            <p className="text-sm font-semibold text-brand-teal">{t("Organizer dashboard")}</p>
            <h1 className="mt-2 text-3xl font-black text-gray-950 break-words">{dashboard.organization.name}</h1>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat) => (
            <div key={stat.label} className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
              <stat.icon className="mb-3 size-5 text-brand-teal" aria-hidden="true" />
        ...
        <div className="mt-6 rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
          <h2 className="text-xl font-bold text-gray-950">{t("Next organizer tasks")}</h2>
