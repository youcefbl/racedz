  ...
  return (
    <form action={formAction} className="grid gap-4 rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-lg font-black text-gray-950">Invite organization user</h2>
      </div>
      {state.error ? (
      ...
      {!canInvite ? <p className="text-sm text-gray-500">Only organization owners and admins can invite users.</p> : null}
    </form>
  );
}
