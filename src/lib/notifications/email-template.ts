...
export function renderRaceDzEmailHtml({ preheader, title, body, action, meta = [] }: RaceDzEmailTemplateInput) {
  ...
  const actionHtml = action
    ? `<table role="presentation" cellspacing="0" cellpadding="0" style="margin-top:28px">
        <tr>
          <td style="border-radius:10px;background:#F47A20">
      ...
      <p style="margin:14px 0 0;color:#9ca3af;font-size:12px;line-height:1.6">Button not working? Copy and paste this link:<br /><a href="${escapeHtml(action.href)}" style="color:#15803D;word-break:break-all">${escapeHtml(action.href)}</a></p>`
    : "";
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;border-collapse:collapse">
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td style="vertical-align:middle;padding-left:10px">
                          <span style="font-size:22px;font-weight:900;color:#0f172a;letter-spacing:-0.5px">Zid<span style="color:#15803D">Run</span></span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td style="background:#ffffff;border:1px solid #e5e7eb;border-radius:18px;overflow:hidden">
                    <div style="height:6px;background:linear-gradient(90deg,#15803D,#F47A20,#a3e635,#ec4899)"></div>
                ...
                <tr>
                  <td style="padding:22px 6px 0;color:#9ca3af;font-size:12px;line-height:1.7">
                    <div style="font-weight:800;color:#6b7280">ZidRun — Find, register, and manage races across Algeria.</div>
                    <div style="margin-top:6px">You received this email because you have a ZidRun account or race registration. Manage notifications anytime from your account settings.</div>
                    <div style="margin-top:12px">© ${year} ZidRun · <a href="${escapeHtml(appUrl)}" style="color:#15803D;text-decoration:none">zidrun.com</a></div>
                  </td>
                </tr>
