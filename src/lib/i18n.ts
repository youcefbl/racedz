...
export const dictionaries = {
  en: {
    ...
    pages: {
      blog: {
        ...
        productPrice: "Price",
        productWhere: "Where to buy",
        viewProduct: "Product page",
        imageDisclosure: "Illustrative image created for ZidRun.",
        roadRecordsCaption: "Current road-running world-record snapshot",
        recordDistance: "Distance",
        recordMen: "Men",
        recordWomen: "Women",
        recordsReviewed: "Reviewed {date}. Recent performances can remain subject to World Athletics ratification. Women’s 5K and 10K values shown are mixed-race records.",
        categories: {
          gear: "Gear",
          training: "Training",
          racing: "Racing",
      ...
      coachLanding: {
        ...
        previewEyebrow: "A week built from your reality",
        previewTitle: "Your next session is already clear",
        previewText: "The coach turns your goal, recent runs, recovery, and available days into one practical next step.",
        previewWorkoutLabel: "Next workout",
        previewWorkoutTitle: "Easy run · conversational effort",
        previewWorkoutBadge: "Today",
        previewMetricOne: "30 min",
        previewMetricTwo: "Easy",
        previewMetricThree: "No pressure",
        previewCoachLabel: "Coach note:",
        previewCoachText: "Keep this one comfortable. The consistency matters more than the speed.",
        featuresTitle: "Everything your training needs",
        featuresIntro: "One coach for the full loop: decide what to do, execute it, understand how it went, and adapt before the next run.",
        trainGroupTitle: "Train with a plan you can actually follow",
        trainGroupText: "Build toward a race or simply become more consistent. The coach respects your current level and the time you really have.",
        learnGroupTitle: "Understand what your body is telling you",
        learnGroupText: "Turn runs, sleep, effort, and questions into useful decisions instead of more noise and more numbers.",
        stayOnTrackGroupTitle: "Stay supported between sessions",
        stayOnTrackGroupText: "Get the right nudge, adjustment, and context without losing control of your data or your choices.",
        ...
        guidedTitle: "Guided workouts and audio cues",
        guidedText: "Follow structured warm-ups, intervals, recoveries, and cool-downs with optional voice guidance while you run.",
        chatTitle: "Ask questions in a real conversation",
        chatText: "Ask why a session is on your plan, what to do after a hard run, or how to adjust when your week changes.",
        recoveryTitle: "Sleep and recovery context",
        recoveryText: "Log sleep, fatigue, pain, and effort so the coach can steer you toward the right load — including a rest day.",
        nutritionTitle: "Practical nutrition support",
        nutritionText: "Log food and hydration context when you want it, then get simple guidance around training and recovery.",
        weatherTitle: "Weather and run context",
        weatherText: "Use conditions, terrain, elevation, and recent training to make sessions more realistic for where you run.",
        tipsFeatureTitle: "Daily tips and gentle reminders",
        tipsFeatureText: "Get short, useful nudges matched to your goal and routine — never a generic feed shouting at you.",
        memoryTitle: "Coach memory you can review",
        memoryText: "Keep helpful preferences and context between conversations, with controls to review, remove, or stop remembering.",
        safetyFeatureTitle: "Safety-aware boundaries",
        safetyFeatureText: "The coach keeps intensity conservative, respects pain and illness signals, and tells you when professional help matters.",
        langNote: "Coaching in Arabic, French, or English — your choice.",
        examplesEyebrow: "See the difference",
        examplesTitle: "Not just a plan. A coach for the moments between runs.",
        examplesIntro: "Here is what a useful coaching exchange can look like inside ZidRun. The response changes with your goal, history, and today’s context.",
        exampleGoalLabel: "Before the week",
        exampleGoalTitle: "You have a race on the calendar",
        exampleGoalPrompt: "I have a 10K in eight weeks. I can run three days and I am coming back after a break.",
        exampleGoalResponse: "We will start with easy volume, one controlled quality session, and a long run that grows only when your recent running supports it.",
        exampleRunLabel: "After a run",
        exampleRunTitle: "You want to know what mattered",
        exampleRunPrompt: "6.2 km in 38:12. The first half felt easy, then my effort climbed to 7/10.",
        exampleRunResponse: "Your finish was strong, but the effort rose early. Keep the next easy day truly easy so the quality work can land.",
        exampleLifeLabel: "When life changes",
        exampleLifeTitle: "Your body or schedule says slow down",
        exampleLifePrompt: "I slept badly and my knee feels sore. Should I do the intervals today?",
        exampleLifeResponse: "Skip the intervals. Choose rest or an easy alternative only if movement feels comfortable; stop if pain continues and seek qualified advice.",
        exampleCoachLabel: "Coach:",
        ...
        trustTitle: "Helpful coaching should still feel like your data and your decision.",
        trustText: "ZidRun keeps the coach personal without making it mysterious. You decide what to share, what the coach remembers, and when a session needs to stop.",
        privacyTitle: "Private by default",
        privacyText: "Your runs and coaching context are yours. Review memory and privacy controls from your account.",
        safetyTitle: "Conservative by design",
        safetyText: "The coach is not a doctor. Pain, illness, or uncertainty are reasons to pause and seek qualified help.",
        controlTitle: "You stay in control",
        controlText: "Change your goal, move a session, skip a workout, switch language, or delete saved context.",
        disclaimer: "AI-generated guidance is general training information, not medical advice. Listen to your body and follow professional guidance when needed."
      },
      organizers: {
    ...
    profile: {
      ...
      privacyToggle: "Make my profile private",
      privacyHint: "Hide you from public leaderboards and other runners' activity feeds, and stop new followers. Your own data stays visible to you.",
    ...
    registrations: {
      ...
      resultDnf: "Did not finish",
      resultDns: "Did not start",
      resultDsq: "Disqualified",
    ...
    auth: {
      ...
      errInvalidCode: "Invalid or expired code. Try again, or use a recovery code.",
  ...
  fr: {
    ...
    races: {
      ...
      resultCount: "Courses trouvées : {count}",
    ...
    raceDetail: {
      registrationCloses: "Inscriptions jusqu'au {date}",
      placesAvailable: "{available} places disponibles sur {total}",
      ...
      cutoffTime: "Temps limite : {hours} h",
    ...
    registration: {
      ...
      eyebrow: "Inscription",
      intro:
        "Confirmez votre distance et les coordonnées de votre contact d'urgence. Votre profil sera mis à jour avec les informations de coureur saisies ici.",
      ...
      wilaya: "Wilaya",
      city: "Ville",
      raceSelection: "Choix de la distance",
      distance: "Distance",
    ...
    pages: {
      blog: {
        metaTitle: "Blog de la course à pied — Équipement, entraînement et courses en Algérie",
        metaDescription:
        ...
        eyebrow: "Le journal ZidRun",
        title: "Le blog de la course à pied en Algérie",
        subtitle: "Guides d'équipement, conseils d'entraînement et astuces pour les courses — pensés pour les coureurs en Algérie.",
        featured: "À la une",
        ...
        productPrice: "Prix",
        productWhere: "Où acheter",
        viewProduct: "Fiche produit",
        imageDisclosure: "Image d’illustration créée pour ZidRun.",
        roadRecordsCaption: "Aperçu actuel des records du monde sur route",
        recordDistance: "Distance",
        recordMen: "Hommes",
        recordWomen: "Femmes",
        recordsReviewed: "Vérifié le {date}. Les performances récentes peuvent rester soumises à la ratification de World Athletics. Les records féminins du 5 km et du 10 km indiqués sont ceux des courses mixtes.",
        categories: {
          gear: "Équipement",
      ...
      coachLanding: {
        ...
        title: "Votre coach de course doté d'IA, gratuit pendant 7 jours.",
        intro:
        ...
        primaryCtaMember: "Ouvrir mon espace coach",
        secondaryCta: "Voir les courses",
        trialNote: "Sans carte bancaire. Vos 7 premiers jours de coaching sont offerts.",
        previewEyebrow: "Une semaine basée sur votre réalité",
        previewTitle: "Votre prochaine séance est claire",
        previewText: "Le coach transforme votre objectif, vos sorties récentes, votre récupération et vos jours disponibles en une prochaine étape concrète.",
        previewWorkoutLabel: "Prochaine séance",
        previewWorkoutTitle: "Sortie facile · effort conversationnel",
        previewWorkoutBadge: "Aujourd'hui",
        previewMetricOne: "30 min",
        previewMetricTwo: "Facile",
        previewMetricThree: "Sans pression",
        previewCoachLabel: "Note du coach :",
        previewCoachText: "Restez à l'aise aujourd'hui. La régularité compte plus que la vitesse.",
        featuresTitle: "Tout ce dont votre entraînement a besoin",
        featuresIntro: "Un seul coach pour toute la boucle : décider quoi faire, le réaliser, comprendre la séance et ajuster la suite.",
        trainGroupTitle: "Un plan que vous pouvez vraiment suivre",
        trainGroupText: "Préparez une course ou construisez simplement votre régularité. Le coach respecte votre niveau actuel et le temps dont vous disposez réellement.",
        learnGroupTitle: "Comprenez les signaux de votre corps",
        learnGroupText: "Transformez vos sorties, votre sommeil, votre effort et vos questions en décisions utiles — pas en chiffres supplémentaires.",
        stayOnTrackGroupTitle: "Restez accompagné entre deux séances",
        stayOnTrackGroupText: "Recevez le bon rappel et le bon ajustement, tout en gardant le contrôle de vos données et de vos choix.",
        planTitle: "Plans hebdomadaires intelligents",
        planText: "Un plan personnalisé et progressif, basé sur votre volume récent et vos disponibilités — ajusté chaque semaine.",
        ...
        guidedTitle: "Séances guidées et consignes audio",
        guidedText: "Suivez échauffements, intervalles, récupérations et retours au calme avec un guidage vocal optionnel pendant votre sortie.",
        chatTitle: "Posez vos questions dans une vraie conversation",
        chatText: "Demandez pourquoi une séance est au programme, quoi faire après une sortie difficile ou comment adapter votre semaine.",
        recoveryTitle: "Sommeil et récupération",
        recoveryText: "Notez sommeil, fatigue, douleur et effort pour orienter la charge — y compris vers un jour de repos.",
        nutritionTitle: "Conseils nutrition simples",
        nutritionText: "Ajoutez si vous le souhaitez votre contexte alimentaire et votre hydratation, puis recevez des conseils liés à l'entraînement.",
        weatherTitle: "Météo et contexte de sortie",
        weatherText: "Les conditions, le terrain, le dénivelé et votre entraînement récent rendent les séances plus réalistes pour votre parcours.",
        tipsFeatureTitle: "Conseils quotidiens et rappels doux",
        tipsFeatureText: "Recevez de courtes suggestions adaptées à votre objectif et votre routine — jamais un fil générique qui vous sollicite sans raison.",
        memoryTitle: "Une mémoire du coach contrôlable",
        memoryText: "Conservez des préférences utiles entre les conversations, avec la possibilité de consulter, supprimer ou désactiver cette mémoire.",
        safetyFeatureTitle: "Des limites pensées pour la sécurité",
        safetyFeatureText: "Le coach garde l'intensité prudente, respecte les signaux de douleur ou de maladie et indique quand un professionnel est nécessaire.",
        langNote: "Coaching en arabe, français ou anglais — à votre choix.",
        examplesEyebrow: "Voyez la différence",
        examplesTitle: "Pas seulement un plan : un coach pour les moments entre deux sorties.",
        examplesIntro: "Voici à quoi peut ressembler un échange utile dans ZidRun. La réponse évolue selon votre objectif, votre historique et votre contexte du jour.",
        exampleGoalLabel: "Avant la semaine",
        exampleGoalTitle: "Une course est inscrite au calendrier",
        exampleGoalPrompt: "J'ai un 10 km dans huit semaines. Je peux courir trois jours et je reprends après une pause.",
        exampleGoalResponse: "Nous commencerons par du volume facile, une séance de qualité maîtrisée et une sortie longue qui progressera seulement si vos dernières semaines le permettent.",
        exampleRunLabel: "Après une sortie",
        exampleRunTitle: "Vous voulez savoir ce qui compte",
        exampleRunPrompt: "6,2 km en 38 min 12. La première moitié était facile, puis mon effort est monté à 7/10.",
        exampleRunResponse: "Votre fin de sortie était solide, mais l'effort est monté tôt. Gardez la prochaine journée facile vraiment facile pour assimiler la qualité.",
        exampleLifeLabel: "Quand la vie change",
        exampleLifeTitle: "Votre corps ou votre agenda demande de ralentir",
        exampleLifePrompt: "J'ai mal dormi et mon genou est sensible. Dois-je faire les intervalles aujourd'hui ?",
        exampleLifeResponse: "Évitez les intervalles. Reposez-vous ou choisissez une alternative facile seulement si le mouvement est confortable ; si la douleur persiste, arrêtez-vous et demandez un avis qualifié.",
        exampleCoachLabel: "Coach :",
        ...
        step2Text: "Ajoutez chaque sortie ou suivez-la en direct ; le coach s'appuie sur votre niveau réel.",
        ...
        personalizeText: "Le coach adapte chaque semaine d'entraînement à votre niveau, votre condition physique, votre historique et votre emploi du temps — en veillant à la sécurité de chaque séance.",
        factorLevelTitle: "Votre niveau",
        factorLevelText: "Que vous construisiez votre première base ou visiez un record personnel, le plan s'adapte à votre niveau.",
        ...
        langText: "Chaque plan, analyse et conseil en arabe, français ou anglais — changez de langue quand vous voulez, avec une prise en charge complète du sens droite-gauche.",
        trustTitle: "Un coaching utile doit rester votre donnée et votre décision.",
        trustText: "ZidRun rend le coach personnel sans le rendre mystérieux. Vous choisissez ce que vous partagez, ce qu'il mémorise et quand une séance doit s'arrêter.",
        privacyTitle: "Privé par défaut",
        privacyText: "Vos sorties et votre contexte de coaching vous appartiennent. Consultez la mémoire et les contrôles de confidentialité depuis votre compte.",
        safetyTitle: "Prudent par conception",
        safetyText: "Le coach n'est pas un médecin. Douleur, maladie ou doute sont des raisons de faire une pause et de demander un avis qualifié.",
        controlTitle: "Vous gardez le contrôle",
        controlText: "Changez votre objectif, déplacez une séance, passez votre tour, changez de langue ou supprimez le contexte enregistré.",
        disclaimer: "Les conseils générés par l'IA sont des informations générales d'entraînement, pas un avis médical. Écoutez votre corps et suivez les recommandations professionnelles nécessaires."
      },
      organizers: {
      ...
      runners: {
        ...
        appFeature1: "Enregistrez vos sorties avec le GPS — distance, allure, dénivelé et carte du parcours.",
        ...
        trackText: "Suivez votre sortie en direct avec le GPS — distance, allure, temps intermédiaires au kilomètre, dénivelé et parcours sur une carte.",
        ...
        appThemesNote: "Mode clair, sombre ou course — l'application s'adapte à vos préférences.",
        appShotAltLight: "Écran d'accueil de l'application ZidRun en mode clair, avec la recherche de courses.",
        appShotAltDark: "Écran d'accueil de l'application ZidRun en mode sombre, avec la recherche de courses."
      },
      rankings: {
        eyebrow: "Classements",
    ...
    profile: {
      ...
      commune: "Commune",
      avatar: "Avatar",
      avatarImage: "Photo de profil",
      privacyTitle: "Confidentialité",
      privacyToggle: "Rendre mon profil privé",
      privacyHint: "Vous masque des classements publics et des fils d'activité des autres coureurs, et empêche de nouveaux abonnés. Vos données restent visibles pour vous.",
    ...
    notifications: {
      ...
      unreadCount: "Notifications non lues : {count}",
    ...
    registrations: {
      ...
      resultFinished: "Terminé",
      resultDnf: "Abandon",
      resultDns: "Non partant",
      resultDsq: "Disqualifié",
    ...
    pay: {
      ...
      proofHelp: "Ajoutez une capture claire de votre virement afin que l'organisateur puisse le confirmer.",
    ...
    auth: {
      ...
      errInvalidCode: "Code invalide ou expiré. Réessayez ou utilisez un code de secours.",
  ...
  ar: {
    ...
    home: {
      eyebrow: "ZidRun",
      title: "اعثر على سباقك القادم في الجزائر.",
      subtitle: "ماراثونات وسباقات 10 كم وسباقات ترايل وفعاليات محلية في مكان واحد.",
      findRace: "ابحث عن سباق",
      createEvent: "أنشئ فعالية",
      heroNote: "فعاليات قادمة في مختلف أنحاء الجزائر",
    ...
    races: {
      ...
      resultCount: "عدد السباقات: {count}",
      ...
      emptyFilteredTitle: "لا توجد سباقات تطابق عوامل التصفية التي اخترتها",
      emptyFilteredText: "وسّع نطاق البحث أو امسح عوامل التصفية.",
      sortLabel: "ترتيب حسب",
      sortDate: "الأقرب موعدًا",
    ...
    raceDetail: {
      ...
      placesAvailable: "{available} مكانًا متاحًا من أصل {total}",
      registerNow: "سجّل الآن",
      registrationClosed: "التسجيلات {status}.",
      categoriesTitle: "المسافات والفئات",
      elevationGain: "ارتفاع مكتسب قدره {meters} م",
      cutoffTime: "الحد الزمني: {hours} ساعة",
    ...
    registration: {
      ...
      eyebrow: "التسجيل",
      intro:
        "أكّد مسافتك وبيانات جهة الاتصال في حالات الطوارئ. سيُحدَّث ملفك الشخصي بمعلومات العدّاء التي تُدخلها هنا.",
    ...
    pages: {
      blog: {
        ...
        subtitle: "أدلة المعدات ونصائح التدريب وإرشادات السباقات — مكتوبة للعدّائين في الجزائر.",
        featured: "مختارات",
        ...
        productPrice: "السعر",
        productWhere: "مكان الشراء",
        viewProduct: "صفحة المنتج",
        imageDisclosure: "صورة توضيحية أُنشئت لصالح ZidRun.",
        roadRecordsCaption: "لقطة حالية للأرقام القياسية العالمية على الطريق",
        recordDistance: "المسافة",
        recordMen: "الرجال",
        recordWomen: "النساء",
        recordsReviewed: "تمت المراجعة في {date}. قد تبقى الإنجازات الحديثة خاضعة لتصديق World Athletics. أرقام السيدات في 5 كلم و10 كلم المعروضة تخص السباقات المختلطة.",
        categories: {
          gear: "المعدات",
          training: "التدريب",
          racing: "السباقات",
      ...
      coachLanding: {
        eyebrow: "مدرب ZidRun",
        title: "مدربك للجري بالذكاء الاصطناعي، مجانًا لمدة 7 أيام.",
        intro:
        ...
        previewEyebrow: "أسبوع مبني على واقعك",
        previewTitle: "حصتك القادمة واضحة الآن",
        previewText: "يحوّل المدرب هدفك وجرياتك الأخيرة واستشفاءك وأيامك المتاحة إلى خطوة عملية واحدة تالية.",
        previewWorkoutLabel: "الحصة القادمة",
        previewWorkoutTitle: "جري سهل · مجهود يسمح بالكلام",
        previewWorkoutBadge: "اليوم",
        previewMetricOne: "30 دقيقة",
        previewMetricTwo: "سهل",
        previewMetricThree: "بدون ضغط",
        previewCoachLabel: "ملاحظة المدرب:",
        previewCoachText: "حافظ على الراحة اليوم. الاستمرارية أهم من السرعة.",
        featuresTitle: "كل ما يحتاجه تدريبك",
        featuresIntro: "مدرب واحد للدورة كاملة: قرّر ما ستفعله، نفّذه، افهم كيف سار، ثم عدّل خطوتك القادمة.",
        trainGroupTitle: "تدرّب بخطة يمكنك الالتزام بها فعلًا",
        trainGroupText: "حضّر لسباق أو ابنِ الاستمرارية فقط. يحترم المدرب مستواك الحالي والوقت المتاح لك في الواقع.",
        learnGroupTitle: "افهم ما يقوله جسمك",
        learnGroupText: "حوّل الجريات والنوم والمجهود وأسئلتك إلى قرارات مفيدة بدل المزيد من الأرقام والضجيج.",
        stayOnTrackGroupTitle: "ابقَ مدعومًا بين الحصص",
        stayOnTrackGroupText: "احصل على التذكير والتعديل المناسبين مع الحفاظ على التحكم في بياناتك وقراراتك.",
        ...
        goalsText: "حدّد سباقك المستهدف وأيامك المتاحة ويوم الجري الطويل — ويضع المدرب خطتك وفقًا لذلك.",
        guidedTitle: "حصص موجهة وإرشادات صوتية",
        guidedText: "اتبع الإحماء والفترات والاستشفاء والتهدئة مع إرشاد صوتي اختياري أثناء الجري.",
        chatTitle: "اسأل في محادثة حقيقية",
        chatText: "اسأل لماذا توجد حصة في خطتك، ماذا تفعل بعد جري صعب، أو كيف تعدّل أسبوعك عندما تتغير ظروفك.",
        recoveryTitle: "سياق النوم والاستشفاء",
        recoveryText: "سجّل النوم والتعب والألم والمجهود ليساعدك المدرب على اختيار الحمل المناسب — حتى يوم الراحة.",
        nutritionTitle: "دعم عملي للتغذية",
        nutritionText: "سجّل الطعام والترطيب عندما تريد، واحصل على إرشادات بسيطة حول التدريب والاستشفاء.",
        weatherTitle: "الطقس وسياق الجري",
        weatherText: "تأخذ الحصة بعين الاعتبار الظروف والتضاريس والارتفاع وتدريبك الأخير لتناسب المكان الذي تجري فيه.",
        tipsFeatureTitle: "نصائح يومية وتذكيرات لطيفة",
        tipsFeatureText: "احصل على دفعات قصيرة ومفيدة تناسب هدفك وروتينك — لا موجزًا عامًا يزعجك بلا سبب.",
        memoryTitle: "ذاكرة يمكنك مراجعتها",
        memoryText: "احتفظ بالتفضيلات المفيدة بين المحادثات، مع إمكانية المراجعة والحذف وإيقاف التذكر.",
        safetyFeatureTitle: "حدود تراعي السلامة",
        safetyFeatureText: "يحافظ المدرب على شدة متحفظة، ويحترم إشارات الألم والمرض، ويخبرك متى تحتاج إلى مختص.",
        langNote: "تدريب بالعربية أو الفرنسية أو الإنجليزية — حسب اختيارك.",
        examplesEyebrow: "شاهد الفرق",
        examplesTitle: "ليس مجرد خطة، بل مدرب للحظات بين الجريات.",
        examplesIntro: "هكذا يمكن أن تبدو محادثة مفيدة داخل ZidRun. تتغير الإجابة حسب هدفك وتاريخك ووضعك اليوم.",
        exampleGoalLabel: "قبل الأسبوع",
        exampleGoalTitle: "لديك سباق في التقويم",
        exampleGoalPrompt: "عندي سباق 10 كلم بعد 8 أسابيع. أستطيع الجري 3 أيام وأعود بعد توقف.",
        exampleGoalResponse: "سنبدأ بحجم سهل، وحصة جودة مضبوطة، وجري طويل لا يزيد إلا عندما يسمح تدريبك الأخير بذلك.",
        exampleRunLabel: "بعد الجري",
        exampleRunTitle: "تريد معرفة المهم",
        exampleRunPrompt: "جريت 6.2 كلم في 38:12. كان النصف الأول سهلًا ثم ارتفع المجهود إلى 7/10.",
        exampleRunResponse: "نهايتك كانت قوية، لكن المجهود ارتفع مبكرًا. اجعل يومك السهل القادم سهلًا فعلًا ليستفيد جسمك من حصة الجودة.",
        exampleLifeLabel: "عندما تتغير الحياة",
        exampleLifeTitle: "جسمك أو جدولك يطلب التخفيف",
        exampleLifePrompt: "نمت بشكل سيئ وركبتي تؤلمني قليلًا. هل أتمرّن على الفترات اليوم؟",
        exampleLifeResponse: "تجاوز الفترات. اختر الراحة أو بديلًا سهلًا فقط إذا كانت الحركة مريحة؛ توقف إذا استمر الألم واطلب رأيًا مختصًا.",
        exampleCoachLabel: "المدرب:",
        howTitle: "كيف يعمل",
        ...
        personalizeText: "يكيّف المدرب كل أسبوع تدريبي وفق مستواك ولياقتك وتاريخك وجدولك — مع الحفاظ على أمان كل حصة.",
        factorLevelTitle: "مستواك",
        factorLevelText: "سواء كنت تبني قاعدتك الأولى أو تسعى إلى رقم شخصي جديد، تتكيّف الخطة مع مستواك تمامًا.",
        ...
        langText: "كل خطة ومراجعة ونصيحة بالعربية أو الفرنسية أو الإنجليزية — بدّل اللغة متى شئت، مع دعم كامل للكتابة من اليمين إلى اليسار.",
        trustTitle: "التدريب المفيد يظل بياناتك وقرارك.",
        trustText: "يجعل ZidRun المدرب شخصيًا دون أن يجعله غامضًا. أنت تختار ما تشاركه وما يتذكره المدرب ومتى يجب إيقاف الحصة.",
        privacyTitle: "خاص بشكل افتراضي",
        privacyText: "جرياتك وسياق تدريبك ملكك. راجع الذاكرة وإعدادات الخصوصية من حسابك.",
        safetyTitle: "متحفظ من أجل السلامة",
        safetyText: "المدرب ليس طبيبًا. الألم أو المرض أو الشك أسباب للتوقف وطلب مساعدة مختص.",
        controlTitle: "أنت من يتحكم",
        controlText: "غيّر هدفك، حرّك حصة، تخطَّ تمرينًا، بدّل اللغة أو احذف السياق المحفوظ.",
        disclaimer: "الإرشادات التي ينشئها الذكاء الاصطناعي معلومات تدريب عامة وليست نصيحة طبية. استمع إلى جسمك واتبع توجيه المختصين عند الحاجة."
      },
      organizers: {
        eyebrow: "للمنظّمين",
      ...
      runners: {
        ...
        discoverText: "تصفّح سباقات الطريق والترايل والفعاليات المحلية. صفِّ حسب الولاية والمسافة والتاريخ والنوع.",
        ...
        trackText: "تتبّع جريك مباشرةً عبر GPS — المسافة والوتيرة والأزمنة الوسيطة لكل كيلومتر والارتفاع والمسار على الخريطة.",
        rankTitle: "اصعد في الترتيب",
        rankText: "شارك جولاتك وشاهد أسرع الوتيرات وأطول المسافات في ولايتك.",
        appThemesNote: "الوضع الفاتح أو الداكن أو وضع السباق — يتكيّف التطبيق مع ما يناسبك.",
    ...
    profile: {
      ...
      privacyToggle: "اجعل ملفي الشخصي خاصًا",
      privacyHint: "يخفي ملفك عن لوحات الصدارة العامة وموجزات نشاط العدّائين الآخرين، ويمنع المتابعين الجدد من متابعتك. تبقى بياناتك مرئية لك.",
    ...
    notifications: {
      eyebrow: "الحساب",
      title: "الإشعارات",
      pageIntro: "تظهر هنا الموافقات على السباقات وتحديثات التسجيل ورسائل المنظّمين وتنبيهات الحساب.",
      emptyTitle: "لا توجد إشعارات بعد",
      emptyText: "ستظهر تحديثات ZidRun الجديدة هنا عند توفر معلومات جديدة.",
      ...
      unreadCount: "الإشعارات غير المقروءة: {count}",
    ...
    registrations: {
      eyebrow: "الحساب",
      title: "تسجيلاتي",
      intro: "تابع تسجيلاتك وحالة الدفع وتفاصيل الفعاليات في مكان واحد.",
      findAnother: "ابحث عن سباق آخر",
      resultLabel: "نتيجتك",
      finishTime: "زمن الوصول",
      overallRank: "الترتيب العام",
      categoryRank: "ترتيب الفئة",
      resultFinished: "أنهى السباق",
      resultDnf: "لم يُكمل",
      resultDns: "لم يبدأ",
      resultDsq: "مُستبعَد من السباق",
      certificate: "الشهادة",
    ...
    auth: {
      ...
      loginHeadline: "سجّل الدخول للركض في سباقاتك أو لتنظيم فعالياتك.",
      ...
      featRaceDaysText: "حافظ على جاهزية تسجيلاتك.",
      ...
      errInvalidCode: "الرمز غير صالح أو منتهي الصلاحية. حاول مرة أخرى أو استخدم رمز استرداد.",
      ...
      registerFootnote:
        "بعد التسجيل، تحقّق من بريدك. ستضيف التفاصيل (الهاتف والولاية وبطاقة التعريف) عند التسجيل في أول سباق لك.",
    ...
    ui: {
      ...
      placesAvailable: "{count} مكانًا متاحًا",
      optional: "اختياري"
    },
    common: {
      view: "عرض"
