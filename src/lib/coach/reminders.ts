...
const copy: Record<CoachLocale, { title: string; body: (name: string, days: number | null) => string; cta: string; preheader: string }> = {
  ...
  ar: {
    title: "وقت الحصة الجاية",
    body: (name, days) =>
      `سلام ${name}، ${days ? `فاتت ${days} أيام من آخر جَرية تاعك.` : "ما سجّلت حتى جَرية مزال."} ` +
      "كي تجري بانتظام تبقى محافظ على الفورمة والتقدّم تاعك. جَرية قصيرة وخفيفة اليوم تكفي باش تبقى في الريتم.",
    cta: "افتح الكوتش",
    preheader: "جَرية قصيرة اليوم تعاونك تبقى محافظ على الفورمة."
  }
};
...
> = {
  ...
  ar: {
    title: "ما تنساش الجَرية تاع اليوم 🏃",
    intro: (name) => `سلام ${name}، عندك حصة جري مبرمجة اليوم.`,
    target: (detail) => `حصة اليوم: ${detail}.`,
    weather: (highC) => `الحرارة وين راح تجري توصل قرابة ${highC}° اليوم.`,
    weatherHot: "السخانة راح تكون قوية — اجري بكري ولا بعد الغروب وزيد خذ معاك الماء.",
    weatherRain: "يقدر يطيح الشتا، اختار الوقت مليح والبس حاجة تناسب الجو.",
    fuel: "اشرب الماء مليح طول النهار وكول حاجة خفيفة قبل ما تخرج بساعة ولا ساعتين.",
    askCoach: "عندك سؤال على حصة اليوم؟ سقسي الكوتش في التطبيق.",
    cta: "افتح الكوتش",
    preheader: "الجَرية تاع اليوم، المِيتيو، وكيفاش توجّد روحك."
  }
};
...
const planReadyCopy: Record<CoachLocale, { title: string; body: (name: string) => string; cta: string; preheader: string }> = {
  ...
  ar: {
    title: "سيمانة التدريب الجديدة واجدة",
    body: (name) =>
      `سلام ${name}، كمّل البرنامج اللي فات، ووجدنالك السيمانة الجاية وحدنا — تبدا من اليوم. ` +
      "افتح الكوتش باش تشوف حصص هاذ السيمانة، وسقسيه في أي وقت إذا حبيت تبدّلهم.",
    cta: "شوف برنامج السيمانة",
    preheader: "وجدنالك سيمانة التدريب الجاية وحدنا."
  }
};
...
> = {
  ...
  ar: {
    title: "الدخول للكوتش راح يوفى قريب",
    body: (kind, when) =>
      kind === "TRIAL"
        ? `التجربة المجانية تاع الكوتش توفى في ${when}. اشترك باش يبقاولك البرنامج والتذكيرات.`
        : `الاشتراك تاع الكوتش يوفى في ${when}. جدّد باش يبقاولك البرنامج والتذكيرات.`,
    cta: "سيّر الاشتراك",
    preheader: "جدّد باش يبقاولك البرنامج والتذكيرات."
  }
};
